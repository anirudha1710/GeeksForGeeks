<h2><a href="https://www.geeksforgeeks.org/problems/burst-balloons/1?page=2&category=Arrays&difficulty=Hard&sortBy=submissions">Burst Balloons</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p>You are given <strong>N</strong>&nbsp;balloons, indexed from <strong>0</strong> to <strong>n - 1</strong>. Each balloon is painted with a number on it represented by an array <strong>arr.</strong> You are asked to burst all the balloons.<br>
