<h2><a href="https://www.geeksforgeeks.org/problems/minimum-characters-to-be-added-at-front-to-make-string-palindrome/1?page=2&category=Arrays,Strings&difficulty=Hard&sortBy=submissions">Min Chars to Add for Palindrome</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given string&nbsp;<strong>s</strong>. The task is to find the minimum characters to be added at the front to make string palindrome.</span></p>
<blockquote>
<p><span style="font-size: 18px;">A palindrome is a word that reads the same backwards as forward. Example: "madam".</span></p>
</blockquote>
...
<strong>Output: </strong>2
<strong>Explanation:</strong> Add 2 a's at front of above string to make it palindrome : "aaaacecaaaa"</span></pre>
