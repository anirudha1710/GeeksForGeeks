<h2><a href="https://www.geeksforgeeks.org/problems/number-of-paths0926/1?page=1&category=Mathematical&difficulty=Easy,Medium&sortBy=submissions">Number of paths</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">The problem is to count all the possible paths from top left to bottom right of an <strong>MxN</strong>&nbsp;matrix with the constraints that from each cell you can either move to <strong>right</strong> or <strong>down</strong>.</span></p>
