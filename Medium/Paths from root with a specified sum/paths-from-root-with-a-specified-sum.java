...
class Solution
{
    ...
    public void solve(Node cur, int sum, int csum, ArrayList<Integer> path){
        ...
        if(cur.left!=null) solve(cur.left, sum, csum + cur.data, path);
        if(cur.right!=null) solve(cur.right, sum, csum + cur.data, path);
